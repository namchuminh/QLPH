        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Sửa Thiết Bị Phòng</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            <form method="post">
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="ten" placeholder="Mã thiết bị" name="mathietbi" value="<?php echo $detail[0]['MaThietBi']; ?>" required>
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="ten">Tên Thiết Bị</label>
                    <input type="text" class="form-control" id="ten" placeholder="Tên thiết bị" name="tenthietbi" value="<?php echo $detail[0]['TenThietBi']; ?>" required>
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                    <label for="ten">Mô Tả </label>
                    <textarea class="form-control" rows="5" name="mota" placeholder="Mô tả thiết bị" required><?php echo $detail[0]['MoTa']; ?></textarea>
                  </div>
                </div>
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <input type="number" class="form-control" id="sc" placeholder="Số lượng" name="soluong" value="<?php echo $detail[0]['SoLuong']; ?>" required>
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="phonghoc" required>
                      <?php foreach ($phonghoc as $key => $value): ?>
                        <?php if($detail[0]['MaPhongHoc'] == $value['MaPhongHoc']){ ?>
              ...
              <button class="btn btn-primary">Cập Nhật Thiết Bị</button>
            </form>
          </div>
        </div>
      </div><!-- /.container-fluid -->
